...
/**
 * visitor for small window showing the current players tank
 */
public class SmallVisitor implements Visitor {
    ...
    public SmallVisitor(MapView view, double zoomFactor){
        this.view = view;
    ...
    public void visit(Tank tank) {
        final GraphicsContext context = view.getSmallGraphicsContext2D();
        final Affine ori = context.getTransform();
        final DoubleVec pos = view.modelToSmallView(tank.getChassis().getPos());
    ...
    public void visit(HelplineElement line) {
        final GraphicsContext context = view.getSmallGraphicsContext2D();
        DoubleVec pos = view.modelToSmallView(line.position);
    ...
    public void drawItem(Animation a, StringProperty prop) {
        final GraphicsContext context = view.getSmallGraphicsContext2D();
        final Affine ori = context.getTransform();
        final DoubleVec pos = view.modelToSmallView(a.getPos());
    ...
    public void visit(HeatSeeker projectile) {
        final GraphicsContext context = view.getSmallGraphicsContext2D();
        final Affine ori = context.getTransform();
        final DoubleVec pos = view.modelToSmallView(projectile.getPos());
        context.translate(pos.x, pos.y);
    ...
    public void visit(Asteroid asteroid) {
        final GraphicsContext context = view.getSmallGraphicsContext2D();
        final Affine ori = context.getTransform();
        final DoubleVec pos = view.modelToSmallView(asteroid.getPos());
        context.translate(pos.x, pos.y);
    ...
    public void visit(StationaryAsteroid stationary) {
        final GraphicsContext context = view.getSmallGraphicsContext2D();
        final Affine ori = context.getTransform();
        final DoubleVec pos = view.modelToSmallView(stationary.getPos());
        context.translate(pos.x, pos.y);
    ...
    private void drawItem(MapContent content, StringProperty prop, Shape shape, Color color, double scale) {
        final GraphicsContext context = view.getSmallGraphicsContext2D();
        final Affine ori = context.getTransform();
        final DoubleVec pos = view.modelToSmallView(content.getPos());
        context.translate(pos.x, pos.y);
    ...
    private void drawChain (Tank tank, boolean destroyed){
        final GraphicsContext context = view.getSmallGraphicsContext2D();
        final Affine ori = context.getTransform();
        final DoubleVec pos = view.modelToSmallView(tank.getChain().getPos());
        context.translate(pos.x, pos.y);
        context.rotate(tank.getChain().getRotation());
        if (tank.getType() == TankType.M55 && !destroyed){
        ...
        else if(tank.getType() == TankType.M55 && destroyed){
        ...
        if (tank.getType() == TankType.MARS && !destroyed){
        ...
        else if (tank.getType() == TankType.MARS && destroyed){
        ...
        if(tank.getType() == TankType.PANZERHAUBITZE2000 && !destroyed){
        ...
        else if (tank.getType() == TankType.PANZERHAUBITZE2000 && destroyed){
    ...
    private void drawAntenna (Tank tank, boolean destroyed){
        final GraphicsContext context = view.getSmallGraphicsContext2D();
        final Affine ori = context.getTransform();
        final DoubleVec pos = view.modelToSmallView(tank.getAntenna().getPos());
        context.translate(pos.x, pos.y);
    ...
    private void drawCannon (Tank tank, boolean destroyed){
        final GraphicsContext context = view.getSmallGraphicsContext2D();
        final Affine ori = context.getTransform();
        final DoubleVec pos = view.modelToSmallView(tank.getCannon().getPos());
        context.translate(pos.x, pos.y);
